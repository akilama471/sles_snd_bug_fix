...
init()
{
	...
	precacheShader("killcard");
	precacheShader("killcard_ct");
	precacheShader("killcard_gl");
	precacheShader("killcard_in");
	precacheShader("killcard_jk");
	precacheShader("killcard_mw");
	precacheShader("killcard_ns");
	precacheShader("killcard_pg");
	precacheShader("killcard_sl");
	precacheShader("killcard_yk");
	precacheShader( "sles_killcam_logo" );
	precacheShader( "sles_add" );
	
	precacheShader("sles_notify_clan" );
	precacheShader("sles_notify_facebook" );
	precacheShader("sles_notify_new");
	precacheShader("sles_notify_screenshots");
	precacheShader("sles_notify_warn");
	precacheShader("sles_notify_donates");
	precacheShader("sles_notify_youtube");
	precacheShader("sles_notify_instagram");
	precacheShader("sles_notify_teamspeak");
	precacheShader("sles_notify_music");
	...
	level.fx_sles_run_attack = loadfx("sles/sles_run_attack");
	level.fx_sles_run_defence = loadfx("sles/sles_run_defence"); 	
	level.fx_dust1 = loadfx("sles/dust1");	
	level.fx_dust2 = loadfx("sles/dust2");
